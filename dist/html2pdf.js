...
(function(global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined'
		...
		? define(['es6-promise/auto', 'jspdf', 'html2canvas'], factory)
	...
	Worker.prototype.from = function from(src, type) {
		...
		return this.then(function from_main() {
			...
			switch (type) {
				case 'string':
					return this.set({
						src: createElement('div', { innerHTML: src })
					});
				case 'element':
	...
	Worker.prototype.thenCore = function thenCore(
		...
		var selfPromise = isNative
			? self
			: Worker.convert(_extends({}, self), Promise.prototype);
...
*/
	...
	Worker.prototype.toContainer = function toContainer(page) {
		return orig$1.toContainer
			.call(this)
